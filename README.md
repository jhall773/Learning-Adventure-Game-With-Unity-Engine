...
# Move: 
Use the arrow keys ^, v, <, and > on your keyboard.

# Talk/Interact:
When close to something (a cave door) or someone, press the "T" key on your keyboard to interact/talk to them. 
Note: You need to be fairly close (bumping into) the person/area you are trying to interact with. If nothing happens, please continue exploring elsewhere.

# Move Through Conversations
To move through the conversations, please continue to click inside the black message boxes until yellow words for options appear (in the bottom left). 
Please click one of the yellow-worded options to continue.
